...
console.log(rap);
  return (
    <div className="App">
     ...
     <img src={rap && `http://openweathermap.org/img/wn/${rap.weather?.[0].icon}@4x.png`} alt="" />
     <div>{data ? " 24°C"  : "16°F"} </div>
     ...
     <button onClick={ley}>{data ? "Change to °F" : "Change to °C" }</button>
    </div>
